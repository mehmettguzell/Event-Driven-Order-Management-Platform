...
from payments.exceptions import DomainException
from payments.common.responses import error_response
...
def _handle_domain(exc: Exception, context: dict) -> Response | None:
...
def _handle_http404(exc: Exception, context: dict) -> Response | None:
    ...
    return _build_response(
        "NOT_FOUND", msg, status.HTTP_404_NOT_FOUND, request_id=_get_request_id(context)
    )
...
def _normalize_drf_response(
    exc: APIException, drf_response: Response, context: dict
) -> Response:
